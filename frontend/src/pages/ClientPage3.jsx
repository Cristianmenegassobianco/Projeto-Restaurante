...
export default function ClientPage3() {
  ...
  return (
    <div style={{ backgroundColor: '#3F564C', color: '#D0BAAA', minHeight: '100vh', fontFamily: 'Georgia, serif', backgroundImage: 'radial-gradient(#212322 1px, transparent 1px)', backgroundSize: '40px 40px', backgroundPosition: '0 0, 20px 20px', paddingBottom: '60px' }}>
